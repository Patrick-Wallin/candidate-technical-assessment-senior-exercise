...
import { PeopleMovies, SearchData } from '../../../src/models/people_movies';
...
describe('Testing Search - API', function () {
  ...
  it('respond with GET as /api/search - status 200 and no record', async () => {
